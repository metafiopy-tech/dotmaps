...
Rule: The second item in source_items.json (summer-scoring-camp) has body 'Advanced short game.' with no embedded link
...
predicate, value = 'contains', 'Advanced short game.'
