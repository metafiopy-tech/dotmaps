#!/usr/bin/env python3
"""Grown check r095 — compiled from a banked rule, template-generated.

Rule: The first item's body in source_items.json contains the substring '>summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r095', "pass": False,
...
print(json.dumps({"dot": 'r095', "pass": ok,
