...
Rule: migration.json can be overwritten and read back exactly, confirming write_file works on files other than target_items.json
...
predicate, value = 'equals', 'hello-world-123'
