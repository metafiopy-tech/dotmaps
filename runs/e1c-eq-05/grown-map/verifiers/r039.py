#!/usr/bin/env python3
"""Grown check r039 — compiled from a banked rule, template-generated.

Rule: target_items.json read_file returns the exact raw bytes written, including JSON escape sequences like \u00e9 and \" unmodified (not re-serialized)
...
try:
    ...
    print(json.dumps({"dot": 'r039', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '{"unicode": "café \\u00e9\\u00e8", "quote": "she said \\"hi\\""}'
...
print(json.dumps({"dot": 'r039', "pass": ok,
