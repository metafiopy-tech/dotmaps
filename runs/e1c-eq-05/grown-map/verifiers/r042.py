...
Rule: target_items.json can be written with content containing a newline and tab, and read back exactly preserving those characters unescaped as literal bytes
