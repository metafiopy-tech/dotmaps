#!/usr/bin/env python3
"""Grown check r032 — compiled from a banked rule, template-generated.

Rule: The spring-junior-clinic item's body field, as raw JSON text, contains the escaped substring 'href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r032', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'href=\\"/summer-scoring-camp\\">summer camp</a>.'
...
print(json.dumps({"dot": 'r032', "pass": ok,
