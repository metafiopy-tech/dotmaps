#!/usr/bin/env python3
"""Grown check inherited-004 — compiled from a banked rule, template-generated.

Rule: The 'source_items.json' file contains items with a 'body' attribute.
...
try:
    ...
    print(json.dumps({"dot": 'inherited-004', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"body":'
...
print(json.dumps({"dot": 'inherited-004', "pass": ok,
