#!/usr/bin/env python3
"""Grown check r029 — compiled from a banked rule, template-generated.

Rule: The spring-junior-clinic item's body field, as raw JSON text, equals the escaped string 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r029', "pass": False,
...
print(json.dumps({"dot": 'r029', "pass": ok,
