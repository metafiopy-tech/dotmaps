...
Rule: Writing a JSON array with one item to target_items.json then reading it back returns that exact content
...
predicate, value = 'equals', '[{"slug":"test-item","title":"Test"}]'
