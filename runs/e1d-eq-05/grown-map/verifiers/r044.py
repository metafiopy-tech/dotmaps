#!/usr/bin/env python3
"""Grown check r044 — compiled from a banked rule, template-generated.

Rule: target_items.json can store a non-array JSON object (e.g. {"note": "test-object"}) and reading it back returns that exact object, showing the file isn't restricted to arrays
...
try:
    ...
    print(json.dumps({"dot": 'r044', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '{"note": "test-object"}'
...
print(json.dumps({"dot": 'r044', "pass": ok,
