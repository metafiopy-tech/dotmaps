...
Rule: Writing a JSON array containing an object with slug 'putting-intensive' to target_items.json persists and reading it back contains that slug
...
predicate, value = 'contains', 'putting-intensive'
