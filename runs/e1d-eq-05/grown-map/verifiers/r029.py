...
Rule: source_items.json contains an item with slug 'summer-scoring-camp' titled 'Summer Scoring Camp'
...
predicate, value = 'contains', '"slug": "summer-scoring-camp",    "title": "Summer Scoring Camp"'
