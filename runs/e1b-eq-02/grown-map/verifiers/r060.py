#!/usr/bin/env python3
"""Grown check r060 — compiled from a banked rule, template-generated.

Rule: target_items.json write accepts a numeric (non-string) date value like 20261111 and stores it as-is without coercion to string
...
try:
    ...
    print(json.dumps({"dot": 'r060', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"date":20261111'
...
print(json.dumps({"dot": 'r060', "pass": ok,
