...
Rule: target_items.json can be overwritten with plain non-JSON text like 'not a json at all' and read back exactly, showing no JSON validation at all on write
...
predicate, value = 'equals', 'not a json at all'
