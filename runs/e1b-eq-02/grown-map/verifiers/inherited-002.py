#!/usr/bin/env python3
"""Grown check inherited-002 — compiled from a banked rule, template-generated.

Rule: source_items.json contains an item with slug 'spring-junior-clinic' titled 'Spring Junior Clinic'
...
try:
    ...
    print(json.dumps({"dot": 'inherited-002', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"title": "Spring Junior Clinic"'
...
print(json.dumps({"dot": 'inherited-002', "pass": ok,
