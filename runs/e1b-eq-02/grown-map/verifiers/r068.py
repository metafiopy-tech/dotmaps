...
Rule: migration.json is not protected like source_items.json; it can be overwritten with arbitrary non-JSON text and read back exactly
...
predicate, value = 'equals', 'test123'
