...
Rule: target_items.json write accepts a boolean price value (true) and stores it as-is without coercion to string or number
...
predicate, value = 'contains', '"price":true'
