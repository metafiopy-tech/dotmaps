#!/usr/bin/env python3
"""Grown check r067 — compiled from a banked rule, template-generated.

Rule: migration.json is not read-only; writing arbitrary text 'hello-migration' to it and reading back returns 'hello-migration'
...
try:
    ...
    print(json.dumps({"dot": 'r067', "pass": False,
                      "evidence": "file migration.json missing"}))
    sys.exit(1)

predicate, value = 'equals', 'hello-migration'
...
print(json.dumps({"dot": 'r067', "pass": ok,
