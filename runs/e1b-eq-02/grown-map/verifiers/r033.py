...
Rule: source_items.json item with slug 'spring-junior-clinic' has body field containing escaped-quote text 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
