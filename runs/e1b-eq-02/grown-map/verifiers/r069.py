#!/usr/bin/env python3
"""Grown check r069 — compiled from a banked rule, template-generated.

Rule: migration.json is not protected like source_items.json; it can be overwritten with arbitrary non-JSON text like 'test' and read back exactly
...
try:
    ...
    print(json.dumps({"dot": 'r069', "pass": False,
                      "evidence": "file migration.json missing"}))
    sys.exit(1)

predicate, value = 'equals', 'test'
...
print(json.dumps({"dot": 'r069', "pass": ok,
