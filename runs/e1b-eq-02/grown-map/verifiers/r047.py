...
Rule: target_items.json can be overwritten with an arbitrary non-array JSON object like {"foo": "bar"} and read back exactly, showing no schema/array enforcement
