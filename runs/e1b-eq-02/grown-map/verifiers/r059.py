...
Rule: target_items.json write allows duplicate slugs; writing two items with the same slug 'dup' stores both without deduplication or blocking
...
predicate, value = 'json_item_count', 2
