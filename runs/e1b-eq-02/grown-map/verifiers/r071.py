...
Rule: migration.json writes persist correctly; writing 'persisted-check-123' and reading back returns exactly that text
...
predicate, value = 'equals', 'persisted-check-123'
