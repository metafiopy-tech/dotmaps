#!/usr/bin/env python3
"""Grown check r066 — compiled from a banked rule, template-generated.

Rule: migration.json write persists arbitrary text 'clobber-test-999' and is readable back exactly, confirming writes are NOT reverted
...
try:
    ...
    print(json.dumps({"dot": 'r066', "pass": False,
                      "evidence": "file migration.json missing"}))
    sys.exit(1)

predicate, value = 'equals', 'clobber-test-999'
...
print(json.dumps({"dot": 'r066', "pass": ok,
