...
Rule: target_items.json write is not validated against required_fields; writing an item missing 'price' still succeeds and is stored without it
...
predicate, value = 'contains', 'no-price-item'
