...
Rule: target_items.json write is not validated against required 'slug' field either; an item missing 'slug' is stored as written without being auto-filled or blocked
...
predicate, value = 'contains', 'No Slug'
