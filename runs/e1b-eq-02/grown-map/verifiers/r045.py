#!/usr/bin/env python3
"""Grown check r045 — compiled from a banked rule, template-generated.

Rule: target_items.json write is not validated against required_fields; an item missing 'price' is stored as written, without the field being auto-filled or the write being blocked
...
try:
    ...
    print(json.dumps({"dot": 'r045', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug": "spring-junior-clinic", "title": "Spring Junior Clinic", "date": "2026-04-12"}]'
...
print(json.dumps({"dot": 'r045', "pass": ok,
