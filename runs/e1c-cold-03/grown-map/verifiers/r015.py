#!/usr/bin/env python3
"""Grown check r015 — compiled from a banked rule, template-generated.

Rule: migration.json's source_sha256 field equals '85c4fb1b404c0616e58a8e42f08d640da2971789e33f62b74f41dfc3a0e95fac'
...
try:
    ...
    print(json.dumps({"dot": 'r015', "pass": False,
...
print(json.dumps({"dot": 'r015', "pass": ok,
