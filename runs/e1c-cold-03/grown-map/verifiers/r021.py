...
Rule: source_items.json's fifth item has slug 'holiday-mini-camp' and title 'Holiday Mini Camp'
...
predicate, value = 'contains', '"slug": "holiday-mini-camp",      "title": "Holiday Mini Camp"'
