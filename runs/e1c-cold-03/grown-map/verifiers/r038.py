...
Rule: source_items.json's first item (spring-junior-clinic) body field, as it appears in the raw file text, contains the substring See also <a href=\"/summer-scoring-camp\">summer camp</a>.
