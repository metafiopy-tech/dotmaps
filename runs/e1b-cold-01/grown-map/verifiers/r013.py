...
Rule: source_items.json third item has slug 'putting-intensive' and price '35' (exact substring match)
...
predicate, value = 'contains', '{"slug": "putting-intensive",      "title": "Putting Intensive",      "price": "35"'
