...
Rule: source_items.json fourth item's title and body fields together contain 'Fall Tune-Up' followed later by 'Pre-season sharpening.'
...
predicate, value = 'contains', '"title": "Fall Tune-Up"'
