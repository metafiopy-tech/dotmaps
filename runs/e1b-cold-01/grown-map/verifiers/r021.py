#!/usr/bin/env python3
"""Grown check r021 — compiled from a banked rule, template-generated.

Rule: source_items.json fourth item has title 'Fall Tune-Up', price '40', date '2026-09-14', body 'Pre-season sharpening.' all on one line
...
try:
    ...
    print(json.dumps({"dot": 'r021', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"title": "Fall Tune-Up",           "price": "40", "date": "2026-09-14", "body": "Pre-season sharpening."'
...
print(json.dumps({"dot": 'r021', "pass": ok,
