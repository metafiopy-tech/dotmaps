#!/usr/bin/env python3
"""Grown check r040 — compiled from a banked rule, template-generated.

Rule: The first item in source_items.json (spring-junior-clinic) has body containing the literal substring 'href=\"/summer-scoring-camp\"' (with escaped quotes as stored in the JSON file)
...
try:
    ...
    print(json.dumps({"dot": 'r040', "pass": False,
...
print(json.dumps({"dot": 'r040', "pass": ok,
