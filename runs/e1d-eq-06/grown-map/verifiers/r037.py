...
Rule: Writing a JSON array with slug 'echo-test' and body 'See <a href="/x">x</a>.' to target_items.json preserves that exact file content on read-back
...
predicate, value = 'equals', '[{"slug":"echo-test","title":"Echo","price":"5","date":"2027-04-04","body":"See <a href=\\"/x\\">x</a>."}]'
