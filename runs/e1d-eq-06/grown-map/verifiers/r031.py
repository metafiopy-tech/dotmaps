#!/usr/bin/env python3
"""Grown check r031 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with slug 'body-link-v2' and body 'See <a href="/other">other</a>.' to target_items.json preserves that exact file content on read-back
...
try:
    ...
    print(json.dumps({"dot": 'r031', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"body-link-v2","title":"Body Link V2","price":"10","date":"2027-05-05","body":"See <a href=\\"/other\\">other</a>."}]'
...
print(json.dumps({"dot": 'r031', "pass": ok,
