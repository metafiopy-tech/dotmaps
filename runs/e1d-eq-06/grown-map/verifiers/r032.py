...
Rule: target_items.json write/read does not validate JSON; writing the literal text 'not valid json' and reading it back returns that exact string unchanged
...
predicate, value = 'equals', 'not valid json'
