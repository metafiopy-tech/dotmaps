#!/usr/bin/env python3
"""Grown check r033 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with slug 'echo-final' and body 'Test <a href="/y">y</a> link.' to target_items.json preserves that exact file content on read-back
...
try:
    ...
    print(json.dumps({"dot": 'r033', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"echo-final","title":"Echo Final","price":"7","date":"2027-06-06","body":"Test <a href=\\"/y\\">y</a> link."}]'
...
print(json.dumps({"dot": 'r033', "pass": ok,
