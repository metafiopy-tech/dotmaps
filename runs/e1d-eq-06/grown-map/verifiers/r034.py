#!/usr/bin/env python3
"""Grown check r034 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with slug 'link-test' and body 'See <a href="/other">other</a>.' to target_items.json preserves that exact file content on read-back
...
try:
    ...
    print(json.dumps({"dot": 'r034', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"link-test","title":"Link Test","price":"10","date":"2027-02-02","body":"See <a href=\\"/other\\">other</a>."}]'
...
print(json.dumps({"dot": 'r034', "pass": ok,
