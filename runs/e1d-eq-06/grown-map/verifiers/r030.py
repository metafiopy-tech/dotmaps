#!/usr/bin/env python3
"""Grown check r030 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with one item having slug 'migrated-test', title 'Migrated Test', price '99', date '2027-01-01' to target_items.json and reading it back returns exactly that item
...
try:
    ...
    print(json.dumps({"dot": 'r030', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"migrated-test","title":"Migrated Test","price":"99","date":"2027-01-01"}]'
...
print(json.dumps({"dot": 'r030', "pass": ok,
