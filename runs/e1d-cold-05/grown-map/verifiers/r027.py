#!/usr/bin/env python3
"""Grown check r027 — compiled from a banked rule, template-generated.

Rule: source_items.json's third item (putting-intensive) has title 'Putting Intensive' and body 'Green reading focus.'
...
try:
    ...
    print(json.dumps({"dot": 'r027', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"title": "Putting Intensive",      "price": "35", "date": "2026-05-03", "body": "Green reading focus."'
...
print(json.dumps({"dot": 'r027', "pass": ok,
