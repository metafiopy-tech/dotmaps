#!/usr/bin/env python3
"""Grown check r014 — compiled from a banked rule, template-generated.

Rule: source_items.json contains an item with slug 'summer-scoring-camp' priced '60' dated '2026-06-20'
...
try:
    ...
    print(json.dumps({"dot": 'r014', "pass": False,
...
print(json.dumps({"dot": 'r014', "pass": ok,
