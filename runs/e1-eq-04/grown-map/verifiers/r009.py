#!/usr/bin/env python3
"""Grown check r009 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic body field, as raw JSON text, contains the substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r009', "pass": False,
...
print(json.dumps({"dot": 'r009', "pass": ok,
