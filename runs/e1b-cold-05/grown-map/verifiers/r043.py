...
Rule: target_items.json accepts a mixed-type JSON array [1, "two", {"three":3}, null, true] and reads it back verbatim
...
predicate, value = 'equals', '[1, "two", {"three":3}, null, true]'
