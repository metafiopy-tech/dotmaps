...
Rule: Writing a 3-element JSON array with distinct slug values to target_items.json and reading it back returns the exact same content, preserving order
...
predicate, value = 'equals', '[{"slug":"a"},{"slug":"b"},{"slug":"c"}]'
