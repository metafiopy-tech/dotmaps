...
Rule: filesystem.write_file to target_items.json does not validate JSON syntax; invalid JSON content is written and read back verbatim
...
predicate, value = 'equals', '{invalid json'
