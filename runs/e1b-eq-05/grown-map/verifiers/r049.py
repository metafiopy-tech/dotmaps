...
Rule: After writing the full 5-item source array to target_items.json, the holiday-mini-camp item's price field reads back as '30'
...
predicate, value = 'contains', '"slug": "holiday-mini-camp", "title": "Holiday Mini Camp", "price": "30"'
