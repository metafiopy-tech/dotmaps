...
Rule: After writing the full 5-item source array to target_items.json, the summer-scoring-camp item's date field reads back as '2026-06-20'
...
predicate, value = 'contains', '"date": "2026-06-20"'
