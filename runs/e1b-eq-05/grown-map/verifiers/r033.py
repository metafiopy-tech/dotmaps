...
Rule: After writing the full 5-item source array to target_items.json, the summer-scoring-camp item's price field reads back as '60'
...
predicate, value = 'contains', '"slug": "summer-scoring-camp", "title": "Summer Scoring Camp", "price": "60"'
