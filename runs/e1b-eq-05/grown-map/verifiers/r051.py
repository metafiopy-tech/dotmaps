...
Rule: After writing the full 5-item source array to target_items.json, the putting-intensive item's price field reads back as '35'
...
predicate, value = 'contains', '"putting-intensive", "title": "Putting Intensive", "price": "35"'
