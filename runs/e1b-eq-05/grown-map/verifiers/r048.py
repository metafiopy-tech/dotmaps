...
Rule: After writing the full 5-item source array to target_items.json, the fall-tune-up item's price field reads back as '40'
...
predicate, value = 'contains', '"slug": "fall-tune-up", "title": "Fall Tune-Up", "price": "40"'
