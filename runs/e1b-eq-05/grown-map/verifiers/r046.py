...
Rule: After writing the full 5-item source array to target_items.json, reading it back contains the spring-junior-clinic body text with the link to /summer-scoring-camp
...
predicate, value = 'contains', '/summer-scoring-camp'
