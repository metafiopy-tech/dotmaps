#!/usr/bin/env python3
"""Grown check r085 — compiled from a banked rule, template-generated.

Rule: Writing 'nested-notes-test' to backup/backup/notes.txt results in reading back exactly 'nested-notes-test'
...
try:
    ...
    print(json.dumps({"dot": 'r085', "pass": False,
                      "evidence": "file backup/backup/notes.txt missing"}))
    sys.exit(1)

predicate, value = 'equals', 'nested-notes-test'
...
print(json.dumps({"dot": 'r085', "pass": ok,
