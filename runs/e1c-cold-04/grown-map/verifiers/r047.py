...
Rule: source_items.json's full raw content matches the exact formatted JSON with aligned spacing as observed
...
predicate, value = 'contains', '{"slug": "spring-junior-clinic",   "title": "Spring Junior Clinic",   "price": "45", "date": "2026-04-12", "body": "See also <a href=\\"/summer-scoring-camp\\">summer camp</a>."}'
