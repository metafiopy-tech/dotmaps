#!/usr/bin/env python3
"""Grown check inherited-003 — compiled from a banked rule, template-generated.
...
try:
    ...
    print(json.dumps({"dot": 'inherited-003', "pass": False,
...
print(json.dumps({"dot": 'inherited-003', "pass": ok,
