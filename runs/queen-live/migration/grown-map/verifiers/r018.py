#!/usr/bin/env python3
"""Grown check r018 — compiled from a banked rule, template-generated.

Rule: The 'putting-intensive' item's body field is exactly 'Green reading focus.' with no internal link markup
...
try:
    ...
    print(json.dumps({"dot": 'r018', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"putting-intensive",      "title": "Putting Intensive",      "price": "35", "date": "2026-05-03", "body": "Green reading focus."'
...
print(json.dumps({"dot": 'r018', "pass": ok,
