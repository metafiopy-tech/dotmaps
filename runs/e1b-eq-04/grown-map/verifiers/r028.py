...
Rule: source_items.json contains an item with slug 'putting-intensive' titled 'Putting Intensive'
...
predicate, value = 'contains', '"slug": "putting-intensive",      "title": "Putting Intensive"'
