#!/usr/bin/env python3
"""Grown check r055 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic item body field is exactly 'See also <a href="/summer-scoring-camp">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r055', "pass": False,
...
print(json.dumps({"dot": 'r055', "pass": ok,
