#!/usr/bin/env python3
"""Grown check r035 — compiled from a banked rule, template-generated.

Rule: The first item's body field, as raw JSON text, contains the exact substring '<a href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r035', "pass": False,
...
print(json.dumps({"dot": 'r035', "pass": ok,
