...
Rule: The first item's body field, as raw JSON text, contains the substring 'See also <a href=\"/summer-scoring-camp\">'
...
predicate, value = 'contains', 'See also <a href=\\"/summer-scoring-camp\\">'
