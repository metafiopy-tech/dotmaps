#!/usr/bin/env python3
"""Grown check r017 — compiled from a banked rule, template-generated.

Rule: The first item's body field in source_items.json contains the raw JSON-escaped anchor tag <a href=\"/summer-scoring-camp\">summer camp</a>
...
try:
    ...
    print(json.dumps({"dot": 'r017', "pass": False,
...
print(json.dumps({"dot": 'r017', "pass": ok,
