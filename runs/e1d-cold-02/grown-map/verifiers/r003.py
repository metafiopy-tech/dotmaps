#!/usr/bin/env python3
"""Grown check r003 — compiled from a banked rule, template-generated.

Rule: The first item's body field in source_items.json contains the raw substring '<a href=\"/summer-scoring-camp\">'
...
try:
    ...
    print(json.dumps({"dot": 'r003', "pass": False,
...
print(json.dumps({"dot": 'r003', "pass": ok,
