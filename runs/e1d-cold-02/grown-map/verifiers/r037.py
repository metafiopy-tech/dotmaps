...
Rule: The first item's body field in source_items.json contains the raw (JSON-escaped) substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.' (backslash-quote as literal characters)
