#!/usr/bin/env python3
"""Grown check r062 — compiled from a banked rule, template-generated.

Rule: target_items.json can be written with a single migrated item object containing date '2026-04-12' and read back with that exact date
...
try:
    ...
    print(json.dumps({"dot": 'r062', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '2026-04-12'
...
print(json.dumps({"dot": 'r062', "pass": ok,
