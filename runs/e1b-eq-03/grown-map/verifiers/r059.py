...
Rule: target_items.json can be written with the migrated spring-junior-clinic item and read back containing slug 'spring-junior-clinic' and price '45' together
...
predicate, value = 'contains', '"slug":"spring-junior-clinic","title":"Spring Junior Clinic","price":"45"'
