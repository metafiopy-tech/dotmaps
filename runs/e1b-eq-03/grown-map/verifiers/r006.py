#!/usr/bin/env python3
"""Grown check r006 — compiled from a banked rule, template-generated.

Rule: migration.json specifies source_sha256 value '85c4fb1b404c0616e58a8e42f08d640da2971789e33f62b74f41dfc3a0e95fac'
...
try:
    ...
    print(json.dumps({"dot": 'r006', "pass": False,
...
print(json.dumps({"dot": 'r006', "pass": ok,
