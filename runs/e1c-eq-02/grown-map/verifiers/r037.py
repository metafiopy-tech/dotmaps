...
Rule: Writing a 2-item JSON array with specific slug/title/price/date fields to target_items.json persists and reads back exactly as written
...
predicate, value = 'equals', '[{"slug":"a","title":"A","price":"1","date":"2026-01-01"},{"slug":"b","title":"B","price":"2","date":"2026-02-02"}]'
