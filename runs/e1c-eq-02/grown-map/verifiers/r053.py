...
Rule: Writing a JSON array with an escaped double-quote in a title field to target_items.json persists and reads back with the literal backslash-quote sequence intact (not unescaped)
...
predicate, value = 'contains', 'He said \\"hi\\"'
