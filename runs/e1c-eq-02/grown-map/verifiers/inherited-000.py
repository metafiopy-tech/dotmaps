#!/usr/bin/env python3
"""Grown check inherited-000 — compiled from a banked rule, template-generated.

Rule: source_items.json contains a JSON array (starts with '[') holding item(s) with slug 'spring-junior-clinic'
...
try:
    ...
    print(json.dumps({"dot": 'inherited-000', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"slug": "spring-junior-clinic"'
...
print(json.dumps({"dot": 'inherited-000', "pass": ok,
