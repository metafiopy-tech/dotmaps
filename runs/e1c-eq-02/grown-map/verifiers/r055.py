...
Rule: Writing a JSON array with an escaped newline (\n) in a field to target_items.json persists and reads back with the escaped newline sequence intact
...
predicate, value = 'contains', 'Line1\\nLine2'
