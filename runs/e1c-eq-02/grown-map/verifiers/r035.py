...
Rule: Writing a single-item JSON array to target_items.json persists and reads back exactly as written
...
predicate, value = 'equals', '[{"slug":"test-item","title":"Test","price":"10","date":"2026-01-01"}]'
