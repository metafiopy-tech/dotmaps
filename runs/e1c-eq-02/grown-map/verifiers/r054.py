...
Rule: Writing a JSON array with an escaped double-quote in a title field to target_items.json persists and reads back with the same escaped quote sequence intact
...
predicate, value = 'equals', '[{"slug":"test","title":"He said \\"hi\\"","price":"99","date":"2026-01-01"}]'
