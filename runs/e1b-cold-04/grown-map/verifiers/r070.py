#!/usr/bin/env python3
"""Grown check r070 — compiled from a banked rule, template-generated.
...
try:
    ...
    print(json.dumps({"dot": 'r070', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'no-price-hyp'
...
print(json.dumps({"dot": 'r070', "pass": ok,
