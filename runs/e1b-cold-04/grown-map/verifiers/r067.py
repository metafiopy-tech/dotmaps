...
Rule: target_items.json write/read preserves array order exactly as written, without sorting or reordering
...
predicate, value = 'contains', 'zzz-last"},{"slug":"aaa-first'
