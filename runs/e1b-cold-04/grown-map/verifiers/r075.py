#!/usr/bin/env python3
"""Grown check r075 — compiled from a banked rule, template-generated.
...
try:
    ...
    print(json.dumps({"dot": 'r075', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'no-price-z'
...
print(json.dumps({"dot": 'r075', "pass": ok,
