#!/usr/bin/env python3
"""Grown check r074 — compiled from a banked rule, template-generated.

Rule: target_items.json write/read preserves a bare JSON null literal as-is (not coerced to [] or {})
...
try:
    ...
    print(json.dumps({"dot": 'r074', "pass": False,
...
print(json.dumps({"dot": 'r074', "pass": ok,
