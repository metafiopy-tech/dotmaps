#!/usr/bin/env python3
"""Grown check r068 — compiled from a banked rule, template-generated.

Rule: target_items.json write/read has no schema validation; omitting the required 'price' field succeeds and the item is stored without a price key
...
try:
    ...
    print(json.dumps({"dot": 'r068', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'no-price-test'
...
print(json.dumps({"dot": 'r068', "pass": ok,
