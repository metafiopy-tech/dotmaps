#!/usr/bin/env python3
"""Grown check r072 — compiled from a banked rule, template-generated.
...
try:
    ...
    print(json.dumps({"dot": 'r072', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'no-price-x'
...
print(json.dumps({"dot": 'r072', "pass": ok,
