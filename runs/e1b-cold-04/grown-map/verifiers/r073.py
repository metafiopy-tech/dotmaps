#!/usr/bin/env python3
"""Grown check r073 — compiled from a banked rule, template-generated.

Rule: target_items.json write/read has no JSON validation on write - writing invalid JSON text 'not valid json' succeeds and reads back verbatim
...
try:
    ...
    print(json.dumps({"dot": 'r073', "pass": False,
...
print(json.dumps({"dot": 'r073', "pass": ok,
