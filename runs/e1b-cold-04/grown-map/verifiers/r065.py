...
Rule: target_items.json write/read does not coerce types - a numeric price value (45) is preserved as a number, not converted to string
...
predicate, value = 'contains', '"price":45'
