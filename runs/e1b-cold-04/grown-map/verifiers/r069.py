...
Rule: target_items.json write/read has no schema validation; omitting the required 'price' field still succeeds and is readable as-is
...
predicate, value = 'contains', 'no-price-check'
