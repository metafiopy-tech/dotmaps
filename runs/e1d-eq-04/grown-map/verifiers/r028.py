#!/usr/bin/env python3
"""Grown check r028 — compiled from a banked rule, template-generated.

Rule: Writing a single-item JSON array with spring-junior-clinic fields to target_items.json then reading it back returns that exact content
...
try:
    ...
    print(json.dumps({"dot": 'r028', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"spring-junior-clinic","title":"Spring Junior Clinic","price":"45","date":"2026-04-12"}]'
...
print(json.dumps({"dot": 'r028', "pass": ok,
