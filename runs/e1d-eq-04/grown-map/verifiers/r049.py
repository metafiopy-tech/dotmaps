...
Rule: migration.json can be overwritten with a modified source_sha256 field and read back exactly with the new value
...
predicate, value = 'contains', 'testsha123'
