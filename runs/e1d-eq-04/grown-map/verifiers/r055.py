...
Rule: target_items.json accepts a JSON array of objects with fields not matching migration schema (e.g. 'foo':'bar') and reads back exactly
...
predicate, value = 'equals', '[{"foo":"bar"}]'
