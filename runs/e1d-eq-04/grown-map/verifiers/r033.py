...
Rule: source_items.json contains an item with slug 'putting-intensive' whose body field is 'Green reading focus.'
...
predicate, value = 'contains', 'Green reading focus.'
