#!/usr/bin/env python3
"""Grown check r016 — compiled from a banked rule, template-generated.
...
try:
    ...
    print(json.dumps({"dot": 'r016', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"summer-scoring-camp",    "title": "Summer Scoring Camp",    "price": "60", "date": "2026-06-20"'
...
print(json.dumps({"dot": 'r016', "pass": ok,
