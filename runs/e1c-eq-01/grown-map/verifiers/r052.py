#!/usr/bin/env python3
"""Grown check r052 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with slug 'spring-junior-clinic' and body containing escaped href to target_items.json preserves the literal JSON-escaped substring 'href=\"/summer-scoring-camp\"' when read back
...
try:
    ...
    print(json.dumps({"dot": 'r052', "pass": False,
...
print(json.dumps({"dot": 'r052', "pass": ok,
