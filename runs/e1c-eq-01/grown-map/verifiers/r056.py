...
Rule: Writing a JSON array with 5 full objects (all fields: slug, title, price, date, body) mirroring source_items.json to target_items.json preserves the exact content when read back
