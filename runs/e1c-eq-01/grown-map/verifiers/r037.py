...
Rule: Writing a JSON array with slug 'spring-junior-clinic' and body 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.' to target_items.json, then reading it back, yields that exact JSON text
