#!/usr/bin/env python3
"""Grown check r046 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with an object containing an href with escaped quotes to target_items.json preserves the exact string when read back
...
try:
    ...
    print(json.dumps({"dot": 'r046', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug": "test-link", "body": "See also <a href=\\"/summer-scoring-camp\\">summer camp</a>."}]'
...
print(json.dumps({"dot": 'r046', "pass": ok,
