#!/usr/bin/env python3
"""Grown check r022 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic item body field contains the substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r022', "pass": False,
...
print(json.dumps({"dot": 'r022', "pass": ok,
