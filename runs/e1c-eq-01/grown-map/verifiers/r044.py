...
Rule: Writing a JSON array with an item containing an href with escaped quotes to target_items.json preserves the exact JSON-escaped string when read back
