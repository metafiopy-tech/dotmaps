...
Rule: Writing a JSON array with slug 'spring-junior-clinic' and body containing escaped href to target_items.json preserves the JSON-escaped substring 'href=\"/summer-scoring-camp\"' when read back
