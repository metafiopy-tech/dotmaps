...
Rule: Writing a JSON array containing an object with an href attribute using escaped quotes to target_items.json preserves the exact JSON-escaped string 'href=\"/summer-scoring-camp\"' when read back
