#!/usr/bin/env python3
"""Grown check r043 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with 2 objects to target_items.json and reading it back returns the exact same content
...
try:
    ...
    print(json.dumps({"dot": 'r043', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug":"test-a","value":1},{"slug":"test-b","value":2}]'
...
print(json.dumps({"dot": 'r043', "pass": ok,
