#!/usr/bin/env python3
"""Grown check r053 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with an object having slug 'spring-junior-clinic' and body 'See also <a href="/summer-scoring-camp">summer camp</a>.' to target_items.json preserves the exact string when read back
...
try:
    ...
    print(json.dumps({"dot": 'r053', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'equals', '[{"slug": "spring-junior-clinic", "body": "See also <a href=\\"/summer-scoring-camp\\">summer camp</a>."}]'
...
print(json.dumps({"dot": 'r053', "pass": ok,
