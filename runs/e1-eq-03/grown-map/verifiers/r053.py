...
Rule: Writing a single-item JSON object to target_items.json persists and is readable back exactly
...
predicate, value = 'equals', '[{"title": "Spring Junior Clinic", "price": "45", "date": "2026-04-12"}]'
