...
Rule: Writing a JSON array with a single item containing slug 'test-item' to target_items.json and reading it back contains that slug
...
predicate, value = 'contains', 'test-item'
