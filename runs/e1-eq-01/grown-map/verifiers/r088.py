#!/usr/bin/env python3
"""Grown check r088 — compiled from a banked rule, template-generated.

Rule: The 'spring-junior-clinic' item's body in source_items.json contains the substring /summer-scoring-camp
...
try:
    ...
    print(json.dumps({"dot": 'r088', "pass": False,
...
print(json.dumps({"dot": 'r088', "pass": ok,
