#!/usr/bin/env python3
"""Grown check r086 — compiled from a banked rule, template-generated.

Rule: The 'spring-junior-clinic' item's body in source_items.json contains the literal escaped substring href=\"/summer-scoring-camp\"
...
try:
    ...
    print(json.dumps({"dot": 'r086', "pass": False,
...
print(json.dumps({"dot": 'r086', "pass": ok,
