#!/usr/bin/env python3
"""Grown check r080 — compiled from a banked rule, template-generated.

Rule: The 'fall-tune-up' item in source_items.json has date '2026-09-14' and body 'Pre-season sharpening.' with no link
...
try:
    ...
    print(json.dumps({"dot": 'r080', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"fall-tune-up",           "title": "Fall Tune-Up",           "price": "40", "date": "2026-09-14", "body": "Pre-season sharpening."'
...
print(json.dumps({"dot": 'r080', "pass": ok,
