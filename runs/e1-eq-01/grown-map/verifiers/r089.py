#!/usr/bin/env python3
"""Grown check r089 — compiled from a banked rule, template-generated.

Rule: Writing a JSON array with one item having slug 'demo-item' and price '99' to target_items.json and reading it back returns an item with price '99'
...
try:
    ...
    print(json.dumps({"dot": 'r089', "pass": False,
                      "evidence": "file target_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"price": "99"'
...
print(json.dumps({"dot": 'r089', "pass": ok,
