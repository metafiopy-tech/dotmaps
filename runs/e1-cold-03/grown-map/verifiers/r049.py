#!/usr/bin/env python3
"""Grown check r049 — compiled from a banked rule, template-generated.

Rule: The source item 'spring-junior-clinic' body raw JSON text contains the full escaped sentence 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r049', "pass": False,
...
print(json.dumps({"dot": 'r049', "pass": ok,
