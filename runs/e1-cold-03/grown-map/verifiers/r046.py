...
Rule: The source item 'spring-junior-clinic' body raw JSON text contains the escaped anchor substring '<a href=\"/summer-scoring-camp\">summer camp</a>'
...
predicate, value = 'contains', '<a href=\\"/summer-scoring-camp\\">summer camp</a>'
