#!/usr/bin/env python3
"""Grown check r050 — compiled from a banked rule, template-generated.

Rule: The source item 'spring-junior-clinic' body raw JSON text contains the substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.' (with escaped quotes as stored in the file)
...
try:
    ...
    print(json.dumps({"dot": 'r050', "pass": False,
...
print(json.dumps({"dot": 'r050', "pass": ok,
