...
Rule: The source item 'spring-junior-clinic' body raw JSON text contains the escaped anchor opening tag '<a href=\"/summer-scoring-camp\">'
...
predicate, value = 'contains', '<a href=\\"/summer-scoring-camp\\">'
