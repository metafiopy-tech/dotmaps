...
Rule: source_items.json raw text contains the literal escaped substring href=\"/summer-scoring-camp\" (backslash-quote as stored in JSON) for spring-junior-clinic
