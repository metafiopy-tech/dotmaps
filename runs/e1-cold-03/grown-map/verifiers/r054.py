#!/usr/bin/env python3
"""Grown check r054 — compiled from a banked rule, template-generated.

Rule: The source item 'spring-junior-clinic' body field, as stored in source_items.json raw text, contains the substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.' (escaped quotes as in file)
...
try:
    ...
    print(json.dumps({"dot": 'r054', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', 'See also <a href=\\"/summer-scoring-camp\\">summer camp</a>.'
...
print(json.dumps({"dot": 'r054', "pass": ok,
