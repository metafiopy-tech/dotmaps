#!/usr/bin/env python3
"""Grown check r024 — compiled from a banked rule, template-generated.

Rule: source_items.json's first item body field contains the raw substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.' (with escaped quotes as stored in file)
...
try:
    ...
    print(json.dumps({"dot": 'r024', "pass": False,
...
print(json.dumps({"dot": 'r024', "pass": ok,
