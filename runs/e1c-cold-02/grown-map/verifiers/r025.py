...
Rule: After writing '[{"slug":"test-item","title":"Test Item"}]' to target_items.json, reading it back returns that exact content
...
predicate, value = 'equals', '[{"slug":"test-item","title":"Test Item"}]'
