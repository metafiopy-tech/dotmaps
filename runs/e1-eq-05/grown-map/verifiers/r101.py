#!/usr/bin/env python3
"""Grown check r101 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic entry body contains the substring '/summer-scoring-camp'
...
try:
    ...
    print(json.dumps({"dot": 'r101', "pass": False,
...
print(json.dumps({"dot": 'r101', "pass": ok,
