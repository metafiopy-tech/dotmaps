#!/usr/bin/env python3
"""Grown check r100 — compiled from a banked rule, template-generated.

Rule: source_items.json's putting-intensive entry has body 'Green reading focus.'
...
try:
    ...
    print(json.dumps({"dot": 'r100', "pass": False,
...
print(json.dumps({"dot": 'r100', "pass": ok,
