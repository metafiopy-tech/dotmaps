#!/usr/bin/env python3
"""Grown check r111 — compiled from a banked rule, template-generated.

Rule: source_items.json's fall-tune-up entry has body 'Pre-season sharpening.'
...
try:
    ...
    print(json.dumps({"dot": 'r111', "pass": False,
...
print(json.dumps({"dot": 'r111', "pass": ok,
