#!/usr/bin/env python3
"""Grown check r106 — compiled from a banked rule, template-generated.

Rule: source_items.json's fall-tune-up entry has date '2026-09-14'
...
try:
    ...
    print(json.dumps({"dot": 'r106', "pass": False,
...
print(json.dumps({"dot": 'r106', "pass": ok,
