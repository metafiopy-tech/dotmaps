#!/usr/bin/env python3
"""Grown check r104 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic entry body contains 'summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r104', "pass": False,
...
print(json.dumps({"dot": 'r104', "pass": ok,
