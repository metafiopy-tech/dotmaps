#!/usr/bin/env python3
"""Grown check r105 — compiled from a banked rule, template-generated.

Rule: source_items.json's spring-junior-clinic entry body is exactly 'See also <a href="/summer-scoring-camp">summer camp</a>.'
...
try:
    ...
    print(json.dumps({"dot": 'r105', "pass": False,
...
print(json.dumps({"dot": 'r105', "pass": ok,
