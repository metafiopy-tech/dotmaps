#!/usr/bin/env python3
"""Grown check r107 — compiled from a banked rule, template-generated.

Rule: source_items.json's holiday-mini-camp entry has body 'Two-day fundamentals.'
...
try:
    ...
    print(json.dumps({"dot": 'r107', "pass": False,
...
print(json.dumps({"dot": 'r107', "pass": ok,
