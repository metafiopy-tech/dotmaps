#!/usr/bin/env python3
"""Grown check r097 — compiled from a banked rule, template-generated.

Rule: source_items.json's summer-scoring-camp entry has body 'Advanced short game.'
...
try:
    ...
    print(json.dumps({"dot": 'r097', "pass": False,
...
print(json.dumps({"dot": 'r097', "pass": ok,
