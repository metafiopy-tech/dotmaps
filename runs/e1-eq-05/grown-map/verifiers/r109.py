#!/usr/bin/env python3
"""Grown check r109 — compiled from a banked rule, template-generated.

Rule: source_items.json's holiday-mini-camp entry has price '30'
...
try:
    ...
    print(json.dumps({"dot": 'r109', "pass": False,
...
print(json.dumps({"dot": 'r109', "pass": ok,
