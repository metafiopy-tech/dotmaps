#!/usr/bin/env python3
"""Grown check r102 — compiled from a banked rule, template-generated.

Rule: source_items.json's summer-scoring-camp entry has price '60'
...
try:
    ...
    print(json.dumps({"dot": 'r102', "pass": False,
...
print(json.dumps({"dot": 'r102', "pass": ok,
