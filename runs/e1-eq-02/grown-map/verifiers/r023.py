#!/usr/bin/env python3
"""Grown check r023 — compiled from a banked rule, template-generated.

Rule: source_items.json contains an item with slug 'holiday-mini-camp' titled 'Holiday Mini Camp' dated '2026-12-27'
...
try:
    ...
    print(json.dumps({"dot": 'r023', "pass": False,
                      "evidence": "file source_items.json missing"}))
    sys.exit(1)

predicate, value = 'contains', '"holiday-mini-camp",      "title": "Holiday Mini Camp",      "price": "30", "date": "2026-12-27"'
...
print(json.dumps({"dot": 'r023', "pass": ok,
