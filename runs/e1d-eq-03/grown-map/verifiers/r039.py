...
Rule: source_items.json's summer-scoring-camp item body contains no HTML anchor tag (plain text 'Advanced short game.')
...
predicate, value = 'contains', '"body": "Advanced short game."'
