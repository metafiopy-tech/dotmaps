...
Rule: source_items.json's spring-junior-clinic item body field, as raw JSON text, contains the escaped substring 'See also <a href=\"/summer-scoring-camp\">summer camp</a>.'
