...
Rule: source_items.json's spring-junior-clinic item body field equals exactly 'See also <a href="/summer-scoring-camp">summer camp</a>.' with no extra characters
...
predicate, value = 'contains', '"body": "See also <a href=\\"/summer-scoring-camp\\">summer camp</a>."}'
