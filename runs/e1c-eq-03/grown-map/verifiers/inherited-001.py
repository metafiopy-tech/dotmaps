#!/usr/bin/env python3
"""Grown check inherited-001 — compiled from a banked rule, template-generated.

Rule: source_items.json contains an item with slug 'spring-junior-clinic' dated '2026-04-12'
...
try:
    ...
    print(json.dumps({"dot": 'inherited-001', "pass": False,
...
print(json.dumps({"dot": 'inherited-001', "pass": ok,
