...
Rule: target_items.json can hold the full migrated array of all 5 source items with title, price, date fields, and reading it back returns that exact JSON
...
predicate, value = 'json_item_count', 5
