...
Rule: target_items.json can store a specific migrated array and reading it back returns that exact JSON
...
predicate, value = 'equals', '[{"slug":"holiday-mini-camp","title":"Holiday Mini Camp","price":"30","date":"2026-12-27"}]'
